...
<body>
	...
	<script>
		// Scroll to the productScroll section when the page loads
		window.onload = function() {
			var productScrollSection = document.getElementById("productScroll");
			if (productScrollSection) {
				productScrollSection.scrollIntoView({
					behavior : 'smooth'
				});
			}
		};
